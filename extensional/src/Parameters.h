...
int restart,fixSeed; // Restart condition. 0 -> new run + overwrite, 1 -> continue iteration (not implemented), 2 -> get steady-state structure at it=0 then get data at it=1 (doesn't work)
...
double *rb;
double *px,*py,*pz; //uwrapped position arrays
double rgx,rgy,rgz,*rg;
double *comx,*comy,*comz; //center of mass components of mapped bead positions
